...
from lumos import engine
from lumos.history import get_recent, save_entry

console = Console()


def _display_command(command: str):
    text = Text()
...
def _suggest(description: str, run: bool):
    with console.status("thinking...", spinner="dots"):
        command = engine.suggest(description)
...
def _explain(command: str):
    with console.status("thinking...", spinner="dots"):
        explanation = engine.explain(command)
